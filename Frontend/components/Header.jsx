...
import {VscromeClose} from 'react-icons/vsc'
...
const Header = () => {
   ...
   return <header className={`w-full h-[50px] md:h-[80px] bg-white flex
    ...
    <Wrapper className='h-[60px] flex justify-between items-center'> 
         ...
         <img src="/logo.svg" className="w-[40px] md:w-[60px]"/> 
           ...
           <Menu showCatMenu={showCatMenu} setShowCatMenu = {setShowCatMenu} categories={categories}/>
            ...
            setMobileMenu={setMobileMenu} categories={categories} />}
           ...
           items-center hover:bg-black/[0.05] cursor-pointer relative">
            <AiOutlineHeart className="text-[19px] md:text-[24px]"/>
            <div className="h-[14px] md-h-[18px] min-w-14px md:min-w-18px rounded-full bg-red-600
            absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-[12px] flex
            justify-center items-center md:px-[5px] ">13</div>
           </div>
           ...
           items-center hover:bg-black/[0.05] cursor-pointer relative">
            ...
            {cartItems.length>0 && (
                 <div className="h-[14px] md-h-[18px] min-w-14px md:min-w-18px rounded-full bg-red-600
                 absolute top-1 left-5 md:left-7 text-white text-[10px] md:text-[12px] flex
                 justify-center items-center md:px-[5px] ">
                    {cartItems.length}
                 </div>
            )}
