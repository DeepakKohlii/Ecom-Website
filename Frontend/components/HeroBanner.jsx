...
const HeroBanner = () => {
  return (
    ...
    renderArrowPrev={(clickHandler , hasPrev ) => (
        ...
        h-[30px] md:h-[50px] bg-black z-10 flex items-center justify-center 
    ...
    >
          ...
          <div>
           ...
           text-[15px] md:text-[30px] uppercase font-medium cursor-pointer hover:opacity-90'>Shop Now</div>
          </div>
